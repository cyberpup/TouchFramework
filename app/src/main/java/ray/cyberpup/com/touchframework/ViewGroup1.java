...
public class ViewGroup1 extends ViewGroup {
    ...
    private static final String LOG_TAG = ViewGroup1.class.getSimpleName();

    private Paint mDiagonalLine;

    // TODO: make this accessible in App bar
    enum MODE {REGULAR, INTERCEPT};
    ...
    public ViewGroup1(Context context, AttributeSet attrs, int defStyle) {
        ...
        // TODO: Allow activity to set this value instead of manually setting this
        mMode = MODE.INTERCEPT;
        ...
        switch(event.getActionMasked()){
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if(mMode == MODE.INTERCEPT){
                    ...
                    mActivity.writeToFile(mText + " onTouchEvent returns " + true + "\n");
        ...
        switch(event.getActionMasked()){
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if(mMode == MODE.INTERCEPT){
                    ...
                    //Log.d(LOG_TAG, mText + " onTouchEvent RETURNS: " + b + "\n");
                    mActivity.writeToFile(mText + " onInterceptTouchEvent returns " + true + "\n");
